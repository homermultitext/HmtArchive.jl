...
# ╔═╡ 557f7c5d-86b2-4261-aa22-a013f524e083
function summarizeMS(ms)
...
va_analyses = summarizeMS(va)

# ╔═╡ e20f563b-0dea-4dc5-9133-902e01ed7ffb
md"""Summaries of errors in **$(length(va_analyses))** manuscript pages."""

# ╔═╡ 5ff59bc5-ea3c-4b5b-99b4-d9c6a2668a3d
md"> Plots"
...
cat2histo(va_analyses)


# ╔═╡ a2e434a2-63c0-4e28-ac86-275837ceab96
function totalhisto(v::Vector{PageSummary})
	combo = sort(v, by = pg -> pg.fail2 + pg.fail1, rev = true)
	xlabels = map(report -> objectcomponent(report.urn), combo)
	yvals = map(report -> report.fail1 + report.fail2, combo)
	bar(xlabels, yvals, title = "Total category 1 + category 2 errors")
end
...
manifest_format = "2.0"
project_hash = "c4fca79268e4f08e619cd375c47c7448bfc4aeca"
...
git-tree-sha1 = "1ec13de5fdf95dda10fea62c86ec119fe00bc109"
...
git-tree-sha1 = "7946749c2b568b02f1aced9185643982f6d8e2d9"
...
git-tree-sha1 = "51788b96fb923e2dfb8bac98f2bee114d92b6127"
...
git-tree-sha1 = "5b611d8ce62d1ccbaae9488b32b5a6d437f5eed8"

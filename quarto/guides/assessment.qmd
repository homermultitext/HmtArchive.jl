...
Use the `bad_xref`  function to collect a list of scholia with invalid cross references to *Iliad* passages:

```{julia}
#| warning: false
#| asis: true
nocrossref = HmtArchive.Analysis.bad_xref(dipltext, dse)
